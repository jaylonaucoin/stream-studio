...
describe('ThumbnailWithFallback', () => {
  ...
  it('renders img element when thumbnail string provided', () => {
    renderWithMui(<ThumbnailWithFallback thumbnail="https://example.com/img.jpg" alt="thumb" />);
  ...
  it('has no accessibility violations', async () => {
    const { container } = renderWithMui(<ThumbnailWithFallback thumbnail={null} alt="thumb" />);
